# -*- coding: utf-8 -*-
"""
Bot for Taverna (updated)
Includes:
- URL-button -> opens private chat with bot (start=order_<post_id>)
- TEST_MODE flag (controls whether MyDrop order is final or just for review)
- dotenv support for secrets
- optional Google Cloud Storage upload for photos and order .txt
- saves local backup in ORDERS_DIR

IMPORTANT: After pulling this file, create a .env file (example below) and, if using GCS, place your service account JSON and set GOOGLE_APPLICATION_CREDENTIALS env var.
"""
...
BOT_TOKEN = os.getenv("BOT_TOKEN") or "8283183707:AAFHormTNHarwUseUW1hivCJI1C_7iTjRHw"
BOT_USERNAME = os.getenv("BOT_USERNAME") or "taverna_ukr_bot"
TEST_CHANNEL = os.getenv("TEST_CHANNEL") or "@test_taverna"
MAIN_CHANNEL = os.getenv("MAIN_CHANNEL") or "@taverna_army"
ADMIN_ID = int(os.getenv("ADMIN_ID") or 8367759217)
ORDERS_DIR = os.getenv("ORDERS_DIR") or r"D:\taverna\DaniZamovlen"
MYDROP_API_KEY = os.getenv("MYDROP_API_KEY") or "0304176039fe08da0bd6a2d82c43c8c29b1eb161"
MYDROP_ORDERS_URL = os.getenv("MYDROP_ORDERS_URL") or "https://backend.mydrop.com.ua/dropshipper/api/orders"
NP_API_KEY = os.getenv("NP_API_KEY") or "4ab60b74749e3bef6672d79867724f4d"
NP_API_URL = os.getenv("NP_API_URL") or "https://api.novaposhta.ua/v2.0/json/"
PAGE_SIZE = int(os.getenv("PAGE_SIZE") or 6)

# Telethon
api_id = int(os.getenv("TG_API_ID") or 26537770)
api_hash = os.getenv("TG_API_HASH") or "4a0b761a1d24b8deaf29c5020eac1cc6"
session_name = os.getenv("SESSION_NAME") or "bot1"
supplier_channel = os.getenv("SUPPLIER_CHANNEL") or "land_liz_drop"
supplier_name = os.getenv("SUPPLIER_NAME") or "PhotoLandliz"
