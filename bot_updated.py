...
if not BOT_TOKEN:
    raise RuntimeError("❌ BOT_TOKEN is missing! Please set it in environment variables.")
...
async def cmd_start(msg: Message, state: FSMContext):
    ...
    if args.startswith("order_"):
        try:
            ...
            post_id = None
        await state.update_data(post_message_id=post_id, post_channel=os.getenv("TEST_CHANNEL"))
