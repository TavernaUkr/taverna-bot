...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // z-[10000] — ВИЩЕ за повноекранну Стрічку товарів (ProductFeedView,
      // fixed z-[9999]): VariantSelectionModal (кнопка "Кошик" прямо в
      // стрічці) використовує саме цей Dialog і портал в document.body, тож
      // якщо тут лишити z-50, модалка ховатиметься ЗА чорним фоном стрічки.
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // z-[10000] — та сама причина, що й у DialogOverlay вище.
